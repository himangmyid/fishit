...
local Window = WindUI:CreateWindow({ Title = "Mangkuy", Icon = "https://raw.githubusercontent.com/himangmyid/tesfish/refs/heads/main/3.png", Author = "by Himang", Transparent = true })
Window.Name = GUI_NAMES.Main 
Window:Tag({ Title = "v.1.0.0", Icon = "github", Color = Color3.fromHex("#30ff6a"), Radius = 0, Icon = "https://raw.githubusercontent.com/himangmyid/tesfish/refs/heads/main/3.png" })
